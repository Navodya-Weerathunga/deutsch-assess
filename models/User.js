...
const UserSchema = new mongoose.Schema({
    ...
    plan: { type: String, enum: ['PLATINUM', 'SILVER'], required: function() { return this.role === 'STUDENT'; }},
    status: { type: String, enum: ['ONGOING', 'WITHDREW', 'COMPLETED', 'UNCERTAIN'], required: function() { return this.role === 'STUDENT'; }},
